    ...
    <%@ include file="/includes/libs.jsp" %>
      ...
      <div class="container">
        ...
        <header
          ...
          <a href="<c:url value='/' />"
            class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none fs-2">Buy All Goods
            ...
            <div class="container-fluid">
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <form class="d-flex" role="search">
                  <input style="width: 250px" class="me-2" type="search" placeholder="搜尋商品" aria-label="Search" />
        ...
        <!-- <script type="text/javascript" src="<c:url value='/js/Favorite/favoriteList.js'></c:url>"></script> -->
