        ...
        <%@ include file="/includes/libs.jsp" %>
            ...
            <body style="padding-top: 8%" id="app">
                <%@ include file="/WEB-INF/views/toolbar/navbar.jsp" %>
                    ...
                    <div class="container">
                        <h2 class="text-center py-3">購物車清單</h2>
                        <div class="row mb-3">
                            <div class="col-3"></div>
                            <div class="col-6"></div>
                            <div class="col-3 d-flex justify-content-end"><button class="btn btn-secondary"
                                    type="button" @click="removeAll()" v-show="hasShoppingCartData">移除所有商品</button>
                            </div>
                        </div>
                        <!-- 購物車清單起始 -->
                        <table class="table table-hover text-center" v-show="hasShoppingCartData">
                        ...
                        <div class="container py-3 d-flex justify-content-end">
                            ...
                            <div class="container h4" v-show="hasShoppingCartData">
                                共有 <span class="text-danger">{{totalItemCount}}</span> 項商品，數量 <span
                                    class="text-danger">{{totalQuantity}}</span> 個，訂單總額:
                                <span class="text-danger"><i class="bi bi-currency-dollar"></i> {{totalPrice}}</span>
                            </div>
                        </div>
                        <div class="container text-center" v-show="!hasShoppingCartData">
                            <img class="rounded-5"
                        ...
                        <div class="container gap-2 py-3 d-flex justify-content-around">
                            <a href="<c:url value='/'/>">
                                <button class="btn btn-outline-primary" type="button" v-show="hasShoppingCartData">
                                    繼續購物
                                </button>
                            </a>
                            <button class="btn btn-outline-success" type="button" v-show="hasShoppingCartData">
                                結帳
                            </button>
                        </div>
                        <div class="container gap-2 py-3 d-flex justify-content-around">
                    ...
                    <%@ include file="/WEB-INF/views/toolbar/footer.jsp" %>
                        ...
                        <script type="text/javascript"
                            src="<c:url value='/js/ShoppingCart/shoppingCart.js'></c:url>"></script>
