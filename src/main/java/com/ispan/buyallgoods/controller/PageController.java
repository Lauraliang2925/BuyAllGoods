...
public class PageController {
	...
	//Alan 2023/8/21 1507
	@GetMapping("/")
	public String home1(Model model,HttpSession seesion,@RequestParam(name = "login", required = false) String login) {
		...
		if(login!=null&&login.compareTo("in")==0) {
			...
			model.addAttribute("userName", (seesion.getAttribute("UserName")==null)?"":seesion.getAttribute("UserName"));
			model.addAttribute("photoPath", (seesion.getAttribute("PhotoPath")==null)?"/pic/members/Photo_Default.png":seesion.getAttribute("PhotoPath"));
